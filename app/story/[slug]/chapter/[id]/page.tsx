    ...
    return (
      <div className="container mx-auto px-4 py-10">
        <div className="text-center py-20">
          <h1 className="text-2xl font-bold mb-4">Chương không tồn tại</h1>
          <Button asChild>
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-6">
      ...
      <div className="flex justify-between mb-6">
        <Button variant="outline" size="sm" disabled={chapterId <= 1} asChild>
          <Link href={chapterId > 1 ? `/story/${slug}/chapter/${chapterId - 1}` : "#"}>
            <ArrowLeft className="h-4 w-4 mr-2" />
            Chương trước
          </Link>
        </Button>
        <Button variant="outline" size="sm" disabled={chapterId >= story.chapters} asChild>
          <Link href={chapterId < story.chapters ? `/story/${slug}/chapter/${chapterId + 1}` : "#"}>
            Chương sau
      ...
      <div className="bg-card rounded-lg p-6 shadow-sm border">
        ...
        <div className={`prose dark:prose-invert max-w-none ${fontSizeClasses[fontSize]}`}>
      ...
      <div className="mt-8 border-t pt-6">
        ...
        <div className="space-y-4">
          <div className="border rounded-lg p-4">
            ...
            <p className="text-sm">Chương này hay quá! Không thể đợi đến chương tiếp theo.</p>
          </div>
        </div>
        <div className="mt-4">
          <textarea
